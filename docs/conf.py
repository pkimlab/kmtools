...
# -*- coding: utf-8 -*-
#
# kmtools documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'kmtools.tex', 'kmtools Documentation',
...
texinfo_documents = [
    (master_doc, 'kmtools', 'kmtools Documentation',
     author, 'kmtools', 'One line description of project.',
     'Miscellaneous'),
]
